...
* **Mandatory References**: You MUST always read and refer to the files in the `docs/ai/` directory as well as `@PLANNING.md` and `@DESIGN.md` before starting any task. This ensures you understand the domain, business logic, and design constraints (Strictly Dark Mode).
