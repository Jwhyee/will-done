export const translations = {
  ko: {
    ...
    retrospective: {
      ...
      create_tab: "회고 생성",
      browse_tab: "회고 톺아보기",
      create_title: "Create New Retrospective",
      create_desc: "AI와 함께 업무를 돌아보고 더 나은 내일을 계획하세요.",
      browse_title: "Browse Retrospectives",
      ...
      select_week: "주차 선택",
      select_month: "월 선택",
      selected_range: "선택된 기간 (SELECTED RANGE)",
      final_label: "최종 라벨 (FINAL LABEL)",
      generate_btn: "회고 생성하기",
      generating: "생성 중...",
      gen_message: "회고 생성까지 최대 3분 소요될 수 있습니다. 완료되면 데스크탑 알림으로 알려드릴게요!",
      search_by_date: "날짜로 검색",
      select_date_label: "회고 라벨 선택 (SELECT DATE LABEL)",
      search_btn: "검색하기",
      latest_title: "가장 최근 회고",
      latest_desc: "마지막으로 생성된 회고 내용을 즉시 확인합니다.",
      latest_btn: "최근 회고 보기",
      used_model: "사용된 모델",
  ...
  en: {
    ...
    retrospective: {
      ...
      select_date_label: "SELECT DATE LABEL",
      search_btn: "Search",
