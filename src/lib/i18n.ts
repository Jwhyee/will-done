export const translations = {
  ko: {
    ...
    workspace_setup: {
      ...
      role_intro_tooltip: "본인의 역할과 주요 업무를 설명해주세요. AI가 회고를 작성할 때 참고합니다.",
  ...
  en: {
    ...
    workspace_setup: {
      ...
      role_intro_tooltip: "Describe your role and responsibilities. AI will use this when generating retrospectives.",
