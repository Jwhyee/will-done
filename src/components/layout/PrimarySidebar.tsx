...
export const PrimarySidebar = ({ 
  ...
  return (
    <TooltipProvider delayDuration={0}>
      <aside className="w-14 border-r border-border bg-background flex flex-col items-center pt-12 pb-4 space-y-4 shrink-0 shadow-2xl z-20 select-none relative">
        {/* Sidebar Drag Handle (Top 48px) */}
        <div 
