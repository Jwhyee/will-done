    ...
    <div className="flex-1 flex items-center justify-center p-8 relative h-screen">
      ...
      >
        <DialogContent className={cn(
          "sm:max-w-[560px] h-[720px] bg-surface-elevated border-border text-text-primary shadow-2xl flex flex-col rounded-3xl p-0 border-t-border/50 overflow-hidden antialiased",
          isFirstWorkspace && "[&>button]:hidden"
        )}>
          <DialogHeader className="p-8 pb-4 shrink-0 space-y-4">
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      ...
                      <textarea 
                        ...
                        className="w-full min-h-[180px] bg-background border-border rounded-2xl p-5 text-sm text-text-primary focus:outline-none focus:ring-1 focus:ring-white/10 placeholder:text-text-muted font-medium leading-relaxed shadow-inner resize-none"
                      />
                    </div>
                  </motion.div>
                ) : (
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="p-4 bg-surface rounded-2xl border border-border/50 space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                          <div className="space-y-2">
                            <Label className="text-[10px] font-bold text-text-muted uppercase tracking-widest pl-1">Start</Label>
                          ...
                          <div className="space-y-2">
                            <Label className="text-[10px] font-bold text-text-muted uppercase tracking-widest pl-1">End</Label>
            ...
            <div className="p-8 border-t border-border bg-surface-elevated shrink-0">
              {activeStep === "basic" ? (
                ...
                <div className="flex gap-4">
                  ...
                  >
                    {isFirstWorkspace ? t.workspace_setup.submit_btn : t.workspace_setup.title_new}
                  </Button>
                </div>
              )}
            </div>
