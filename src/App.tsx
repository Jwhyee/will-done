  ...
  return (
    <div className="flex-1 flex overflow-hidden bg-[#111114]">
      <aside className="w-64 border-r border-[#2e2e33] flex flex-col shrink-0 p-6 space-y-8">
        <Button 
          variant="ghost" 
          className="justify-start -ml-2 text-zinc-500 hover:text-white font-bold h-10 px-2 group transition-all"
          onClick={onClose}
        >
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-black tracking-tighter text-white">{t.sidebar.settings}</h2>
          <nav className="space-y-2">
            <Button 
